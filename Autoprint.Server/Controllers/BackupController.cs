...
namespace Autoprint.Server.Controllers
{
    ...
    [ApiController]
    [Authorize(Policy = "ADMIN_ACCESS")] // Sécurité maximale
    public class BackupController : ControllerBase
    {
        ...
        public async Task<IActionResult> Restore([FromBody] BackupRootDto backup)
        {
            ...
            try
            {
                ...
                // On nettoie aussi les settings pour les remplacer par ceux du backup
                _context.ServerSettings.RemoveRange(_context.ServerSettings);

                await _context.SaveChangesAsync();

                // 2. RESTAURATION (Ordre strict pour les FK)
                ...
                // Settings & Mappings (Pas d'Identity Insert nécessaire car clé string ou auto)

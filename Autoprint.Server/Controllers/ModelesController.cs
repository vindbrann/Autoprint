...
namespace Autoprint.Server.Controllers
{
    ...
    public class ModelesController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutModele(int id, Modele inputModele)
        {
            ...
            // 1. VALIDATION DÉFENSIVE (Empêche le crash SQL)
            ...
            // 4. PRÉPARATION AUDIT (Lecture seule pour JSON)
        ...
        public async Task<ActionResult<Modele>> PostModele(Modele modele)
        {
            ...
            // Nettoyage pour éviter que EF n'essaie de créer une Marque doublon
            modele.Marque = null!;
            modele.Pilote = null;

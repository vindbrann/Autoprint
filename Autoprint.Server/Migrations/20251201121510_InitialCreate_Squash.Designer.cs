...
namespace Autoprint.Server.Migrations
{
    ...
    [Migration("20251201121510_InitialCreate_Squash")]
    partial class InitialCreate_Squash
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Autoprint.Shared.Emplacement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CidrIpv4 = "0.0.0.0/0",
                            Code = "ND",
                            DateModification = new DateTime(2025, 12, 1, 12, 15, 10, 486, DateTimeKind.Utc).AddTicks(6835),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Marque", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2025, 12, 1, 12, 15, 10, 486, DateTimeKind.Utc).AddTicks(5265),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Modele", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2025, 12, 1, 12, 15, 10, 486, DateTimeKind.Utc).AddTicks(8401),
                            EstSupprime = false,
                            MarqueId = 1,
                            Nom = "GÉNÉRIQUE"
                        });

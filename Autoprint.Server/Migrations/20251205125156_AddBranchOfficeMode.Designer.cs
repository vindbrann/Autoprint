...
namespace Autoprint.Server.Migrations
{
    ...
    [Migration("20251205125156_AddBranchOfficeMode")]
    partial class AddBranchOfficeMode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Autoprint.Shared.Emplacement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CidrIpv4 = "0.0.0.0/0",
                            Code = "ND",
                            DateModification = new DateTime(2025, 12, 5, 12, 51, 55, 457, DateTimeKind.Utc).AddTicks(477),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Imprimante", b =>
                {
                    ...
                    b.Property<bool>("IsBranchOfficeEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Autoprint.Shared.Marque", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2025, 12, 5, 12, 51, 55, 456, DateTimeKind.Utc).AddTicks(9869),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Modele", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2025, 12, 5, 12, 51, 55, 457, DateTimeKind.Utc).AddTicks(1248),
                            EstSupprime = false,
                            MarqueId = 1,
                            Nom = "GÉNÉRIQUE"
                        });

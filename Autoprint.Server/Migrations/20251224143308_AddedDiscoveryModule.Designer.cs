...
namespace Autoprint.Server.Migrations
{
    ...
    [Migration("20251224143308_AddedDiscoveryModule")]
    partial class AddedDiscoveryModule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Autoprint.Shared.Emplacement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CidrIpv4 = "0.0.0.0/0",
                            Code = "ND",
                            DateModification = new DateTime(2025, 12, 24, 14, 33, 8, 235, DateTimeKind.Utc).AddTicks(5150),
                            EstSupprime = false,
                            Nom = "NON DÉFINI",
                            Status = 0
                        });
            ...
            modelBuilder.Entity("Autoprint.Shared.Marque", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2025, 12, 24, 14, 33, 8, 235, DateTimeKind.Utc).AddTicks(4337),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Modele", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2025, 12, 24, 14, 33, 8, 235, DateTimeKind.Utc).AddTicks(5871),
                            EstSupprime = false,
                            MarqueId = 1,
                            Nom = "GÉNÉRIQUE"
                        });

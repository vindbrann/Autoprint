...
namespace Autoprint.Server.Migrations
{
    ...
    [Migration("20251208112510_RenameBranchToDirect")]
    partial class RenameBranchToDirect
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Autoprint.Shared.Emplacement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CidrIpv4 = "0.0.0.0/0",
                            Code = "ND",
                            DateModification = new DateTime(2025, 12, 8, 11, 25, 9, 518, DateTimeKind.Utc).AddTicks(3754),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Marque", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2025, 12, 8, 11, 25, 9, 518, DateTimeKind.Utc).AddTicks(3218),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Modele", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2025, 12, 8, 11, 25, 9, 518, DateTimeKind.Utc).AddTicks(4376),
                            EstSupprime = false,
                            MarqueId = 1,
                            Nom = "GÉNÉRIQUE"
                        });

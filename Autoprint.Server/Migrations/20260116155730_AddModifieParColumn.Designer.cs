...
namespace Autoprint.Server.Migrations
{
    ...
    [Migration("20260116155730_AddModifieParColumn")]
    partial class AddModifieParColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Autoprint.Shared.Emplacement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CidrIpv4 = "0.0.0.0/0",
                            Code = "ND",
                            DateModification = new DateTime(2026, 1, 16, 15, 57, 30, 398, DateTimeKind.Utc).AddTicks(6673),
                            EstSupprime = false,
                            Nom = "NON DÉFINI",
                            Status = 0
                        });
            ...
            modelBuilder.Entity("Autoprint.Shared.Marque", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2026, 1, 16, 15, 57, 30, 398, DateTimeKind.Utc).AddTicks(6074),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Modele", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2026, 1, 16, 15, 57, 30, 398, DateTimeKind.Utc).AddTicks(7272),
                            EstSupprime = false,
                            MarqueId = 1,
                            Nom = "GÉNÉRIQUE"
                        });

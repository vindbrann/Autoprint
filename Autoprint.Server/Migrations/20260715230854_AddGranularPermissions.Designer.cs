...
namespace Autoprint.Server.Migrations
{
    ...
    [Migration("20260715230854_AddGranularPermissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Autoprint.Server.Models.Security.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 25,
                            Code = "SNMP_PROFILE_READ",
                            Description = "Voir les profils SNMP"
                        },
                        new
                        {
                            Id = 26,
                            Code = "SNMP_PROFILE_WRITE",
                            Description = "Créer/Modifier des profils SNMP"
                        },
                        new
                        {
                            Id = 27,
                            Code = "SNMP_PROFILE_DELETE",
                            Description = "Supprimer des profils SNMP"
                        },
                        new
                        {
                            Id = 28,
                            Code = "REPORT_MANAGE",
                            Description = "Gérer les rapports et la planification"
                        },
                        new
                        {
                            Id = 29,
                            Code = "PRINTER_ARCHIVE",
                            Description = "Archiver/Désarchiver des imprimantes"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.DiscoveryProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ExcludedRanges")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ProbeTargets")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("SkipKnownSubnets")
                        .HasColumnType("bit");

                    b.Property<string>("TargetRanges")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Autoprint.Shared.EmplacementNetwork", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Autoprint.Shared.Imprimante", b =>
                {
                    ...
                    b.Property<bool>("IsDirectPrintingEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Autoprint.Shared.IntegrationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Autoprint.Shared.Marque", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2026, 7, 15, 23, 8, 53, 563, DateTimeKind.Utc).AddTicks(9593),
                            EstSupprime = false,
                            Nom = "NON DÉFINI"
                        });
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Modele", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateModification = new DateTime(2026, 7, 15, 23, 8, 53, 564, DateTimeKind.Utc).AddTicks(698),
                            EstSupprime = false,
                            MarqueId = 1,
                            Nom = "GÉNÉRIQUE"
                        });
            ...
            modelBuilder.Entity("Autoprint.Shared.ReportSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ScopeFilterJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SelectedMetricsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Autoprint.Shared.SnmpProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OidPageCounter")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("OidTonerBlack")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("OidTonerCyan")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("OidTonerMagenta")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.Property<string>("OidTonerYellow")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");

                    b.HasKey("Id");

                    b.ToTable("SnmpProfiles");
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.TonerHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ComponentColor")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("ImprimanteId");

                    b.ToTable("TonerHistories");
                });
            ...
            modelBuilder.Entity("Autoprint.Shared.Modele", b =>
                {
                    ...
                    b.HasOne("Autoprint.Shared.SnmpProfile", "SnmpProfile")
                        .WithMany()
                        .HasForeignKey("SnmpProfileId");

                    b.Navigation("Marque");

                    b.Navigation("Pilote");

                    b.Navigation("SnmpProfile");
                });

            modelBuilder.Entity("Autoprint.Shared.TonerHistory", b =>
                {
                    b.HasOne("Autoprint.Shared.Imprimante", "Imprimante")
                        .WithMany()
                        .HasForeignKey("ImprimanteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
